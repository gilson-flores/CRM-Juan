      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto flex-wrap">
          ...
          <button 
            ...
            className="flex items-center justify-center gap-1.5 bg-[#18181c] hover:bg-[#242429] border border-zinc-700 text-zinc-300 hover:text-white px-3.5 py-2 rounded-lg text-xs font-bold transition-colors"
          >
            <History size={15} className="text-[#FF7A00]" />
            Restaurar Rascunho ({savedDrafts.length})
          </button>
